...
M010 Phase 3 Stage 8 기준으로 Chrome MV3 shell과 Firefox식 overlay UI 기반이 준비됐다.
...
- viewport 밖으로 이어지는 요소는 page 좌표 기준으로 선택되어, 선택 후 window scroll 시 테두리가 같은 문서 영역을 따라간다.
