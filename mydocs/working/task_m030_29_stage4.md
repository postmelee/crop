...
GitHub Community Standards 보강의 마지막 구현 단계로 보안 정책, GitHub Sponsors 설정, GitHub Discussions 게시글 후보를 준비했다.

실제 GitHub Discussions 게시글 생성, GitHub 저장소 설정 변경, GitHub Sponsors profile 변경은 수행하지 않았다.
...
| `mydocs/working/task_m030_29_discussions_drafts.md` | `crop` 소개, 첫 사용 안내, 피드백 요청, 제약/로드맵, 후원 안내 Discussion 후보 5개 작성 |
...
- `.github/FUNDING.yml`은 GitHub Sponsors 설정만 추가했다. 후원은 선택 사항이며 issue/PR 우선순위를 바꾸지 않는다는 문구는 Discussions 후보에만 둔다.
...
sed -n '1,360p' mydocs/working/task_m030_29_discussions_drafts.md
ruby -e 'require "psych"; p Psych.load_file(".github/FUNDING.yml")'
rg -n "CONTRIBUTING|CODE_OF_CONDUCT|SECURITY|SUPPORT|FUNDING|Sponsor|Sponsors|Issue|Pull Request|security|conduct" README.md CONTRIBUTING.md CODE_OF_CONDUCT.md .github mydocs/working/task_m030_29_discussions_drafts.md SECURITY.md
...
rg -n "affiliated|endorsed|sponsored|official|Mozilla|Firefox|debugger|<all_urls>|telemetry|upload|Sponsors|sponsor" SECURITY.md mydocs/working/task_m030_29_discussions_drafts.md .github/FUNDING.yml
...
- OK: Discussions 후보 문서는 5개 게시글 후보를 포함한다.
...
- Discussions 후보는 실제 게시글이 아니다. 게시 전에는 Chrome Web Store 등록 페이지, README, 릴리스 노트와 최신 문구가 맞는지 다시 확인해야 한다.
