...
| `tests/content/overlay/phase6-regression.test.ts` | selected scroll capture fixture marker와 `data-crop-expected-css-size="1520x920"`, 품질 매트릭스 `P6-39` 항목을 고정하는 회귀 테스트를 추가했다. |
| `mydocs/tech/task_m020_8_quality_matrix.md` | P6-13 기준을 #26 구현 방향으로 갱신하고 P6-39 및 수동 smoke 절차, Task #26 갱신 결과 표를 추가했다. |
