...
| `npm run test` 통과 | OK — Vitest v3.2.4, 5개 test file, 46개 test 통과 |
...
- Firefox resize mover 전체, keyboard resize, edge auto-scroll, full page capture는 아직 포팅하지 않았다.
...
- resize handles, keyboard resize, full page capture는 별도 이슈로 분리
