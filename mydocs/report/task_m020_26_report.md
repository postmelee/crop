...
| `mydocs/tech/task_m020_8_quality_matrix.md` | P6-13 기준을 oversized initial 자동 추천 차단으로 재정의하고 P6-37 selected scroll capture 기준과 수동 절차를 유지했다. | internal quality matrix |
