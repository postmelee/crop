...
4. 필요 시 수정·검증 계획 문서 작성: `mydocs/pr/pr_{N}_review_impl.md`
   ...
   - 작성 후 작업지시자 승인 요청
5. 검증 수행 (해당하는 경우만)
   - 검증은 변경 유형에 따라 `Chrome MV3 extension validation: build, targeted tests, and manual unpacked-extension smoke tests for overlay, capture, copy, and save flows.` 정책 적용
